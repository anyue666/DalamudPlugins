...
$dlTemplateInstall = "https://github.com/anyue666/DalamudPlugins/raw/Bluefissure/plugins/{0}/latest.zip"
$dlTemplateUpdate = "https://github.com/anyue666/DalamudPlugins/raw/Bluefissure/plugins/{0}/latest.zip"
